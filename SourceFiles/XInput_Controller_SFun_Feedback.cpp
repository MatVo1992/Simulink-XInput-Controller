...
//              XInput_Controller_SFun_Feedback.cpp                     //
//      Mathias Voigt -  Technische Universität Dresden - 2019          //
//                                                                      //
//              Block with Input (Feedback/Vibration)                   //
// care: high execution time 2ms, not recommended for low sample times  //
//////////////////////////////////////////////////////////////////////////
...
#define S_FUNCTION_NAME  XInput_Controller_SFun_Feedback  // define S-Function Name
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (!ssSetNumInputPorts(S, 1)) return;      // Nr. Inputs = 1
